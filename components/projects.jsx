      ...
      <div className="lg:max-w-[1240px] mt-12  flex gap-8  flex-col lg:flex-row">
        ...
        <div className="lg:w-[603px] lg:ml-8 lg:mt-20 ">
          <div className="pb-4 ">
            ...
            <div className="bg-[#0C1C34] p-2 px-6 border-l-4 border-[#00DF8F] shadow-lg shadow-cyan-500/50">
          ...
          <div className="aboutbuttonsDiv pt-2 lg:ml-0 ">
            <button className="lg:text-base text-sm font-semibold  text-[#00DF8F] hover:text-white">
              VS Code
            </button>
            <button className="lg:text-base text-sm font-semibold px-2 text-[#00DF8F] hover:text-white">
              Sublime Text
            </button>
            <button className="lg:text-base text-sm font-semibold px-2 text-[#00DF8F] hover:text-white">
              Atom
