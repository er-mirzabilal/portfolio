  ...
  return (
    ...
    >
      <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
        ...
        <div>
          <ul style={{ color: `${linkColor}` }} className='hidden items-baseline lg:flex'>
      ...
      >
        ...
        >
          <div>
            ...
            <span className="box-border inline-block lg:w-1 w-1 h-4 ml-2  bg-white  lg:h-8 animate-cursor will-change-transform">
          ...
          <div className='py-4 flex flex-col text-white '>
            <ul className='uppercase '>
              ...
              <Link href='/#contact'>
                <li onClick={() => setNav(false)} className='p-2  text-sm uppercase  w-fit my-4    border-solid  border-2 border-[#02CA82]'>
                  Contact
                </li>
              </Link>
            </ul>
